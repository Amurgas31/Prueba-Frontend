// PostsForm.jsx - Componente de formulario dinámico (funciona para Crear y Editar).
...
const PostsForm = ({ initialData = {}, onSubmit, submitting = false, onClose, categories = [] }) => {
  ...
  // los campos vacíos con los datos reales del producto.
