...
const defaultUsers = [
  { id: 1, email: "john@gmail.com", username: "johnd", password: "1234" },
...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // Autorrellenar email si se guardó la sesión previamente
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Traer todos los usuarios (los por defecto + los nuevo registrados localmente)
